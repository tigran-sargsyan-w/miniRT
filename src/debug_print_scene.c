...
void	debug_print_scene(t_scene *scene)
{
    ...
    {
        sp = &scene->spheres[i];
        printf(" Sphere %d:\n  Center(%.2f, %.2f, %.2f), Diameter: %.2f, Color(%d, %d, %d)\n", i,
    ...
    for (int i = 0; i < scene->plane_count; ++i)
    {
        ...
        printf(" Plane %d:\n  Point(%.2f, %.2f, %.2f), Normal(%.2f, %.2f, %.2f),  Color(%d, %d, %d)\n", i,
    ...
    for (int i = 0; i < scene->cylinder_count; ++i)
    {
        ...
        printf(" Cylinder %d:\n  Center(%.2f, %.2f, %.2f), Orientation(%.2f, %.2f, %.2f), Diameter: %.2f, Height: %.2f, Color(%d, %d, %d)\n", i,
